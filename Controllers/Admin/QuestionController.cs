...
namespace study4_be.Controllers.Admin
{
    public class QuestionController : Controller
    {
        ...
        {
            var questions = await _questionsRepository.GetAllQuestionsAsync(); // Retrieve list of courses from repository
            return View(questions); // Pass the list of courses to the view
        }
